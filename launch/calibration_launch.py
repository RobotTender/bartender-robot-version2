...
def generate_launch_description(overrides=None):
    ...
    vision1 = ExecuteProcess(
        cmd=[
            ...
            '--image-topic', '/camera/camera_1/color/image_raw',
            '--depth-topic', '/camera/camera_1/aligned_depth_to_color/image_raw',
            '--camera-info-topic', '/camera/camera_1/color/camera_info',
            '--output-meta-topic', '/camera/camera_1/calibration/meta',
    ...
    vision2 = ExecuteProcess(
        cmd=[
            sys.executable,
            os.path.join(project_root, 'src', 'vision', 'camera_eye_to_hand_robot_calibration.py'),
            '--image-topic', '/camera/camera_2/color/image_raw',
            '--depth-topic', '/camera/camera_2/aligned_depth_to_color/image_raw',
            '--camera-info-topic', '/camera/camera_2/color/camera_info',
            '--output-meta-topic', '/camera/camera_2/calibration/meta',
            '--cols', LaunchConfiguration('pattern_cols'),
            '--rows', LaunchConfiguration('pattern_rows'),
            '--panel', '2',
        ],
